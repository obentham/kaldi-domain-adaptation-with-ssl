...
srcdir=data/local/$swbd_data  # This is where we downloaded some stuff..
...
chmod 777 $srcdict
cp -f $srcdict $dir/lexicon0.txt || exit 1;
chmod 777 $dir/lexicon0.txt  # fix a strange permission in the source.
...
local/swbd1/swbd1_map_words.pl -f 1 $dir/lexicon2.txt | sort -u \
