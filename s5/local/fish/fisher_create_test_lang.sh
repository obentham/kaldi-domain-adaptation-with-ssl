...
arpa_lm=data/local/fish_lm/3gram-mincount/lm_unpruned.gz
dir=data/fish_lang_final
...
fstprint   --isymbols=data/fish_lang/phones.txt --osymbols=data/fish_lang/words.txt data/fish_lang/L.fst  | head
...
fsttablecompose data/fish_lang/L_disambig.fst $dir/G.fst | \
